...
public class PeriodicTable {
    ...
    public static HashMap<String, Element> makeFastPeriodicTable()
    {
        HashMap<String,Element> hm = new HashMap<>();
        for(String[] i:ELEMENTS)
        {
            hm.put(i[2],new Element(Integer.parseInt(i[0]),i[1],i[2],Double.parseDouble(i[3])));
        }
        return hm;
    }
    public static void main(String[] args) {
        HashMap<String,Element> hmap = new HashMap<>();
        hmap = makeFastPeriodicTable();
